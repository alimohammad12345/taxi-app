...
const Navbar = () => { // Changed component name to start with uppercase (standard practice)
  return (
    <div>
      {/* Top Bar */}
      ...
      <nav className="bg-white px-2 sm:px-4 py-3 shadow-sm sticky top-0 z-50"> {/* Added styles */}
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div
            ...
            id="mobile-menu-4" // Ensure this ID matches data-collapse-toggle
          >
            {/* --- NEW MENU STRUCTURE --- */}
            <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 text-sm font-medium">
              <li>
                <Link href="/">
                  {/* Using NavLink structure for active state - adjust styling as needed */}
